...
def main():
    ...
    # prints out astronaut's name and which spacecraft they are on (ISS)
    for astro in helmetson["people"]:
        if 'ISS' in astro['craft']:
            print(f"{astro['name']} on the {astro['craft']}")

    # prints out astronaut's name and which spacecraft they are on (Shenzhou 15)
    for astro in helmetson["people"]:
        if 'Shenzhou 15' in astro['craft']:
            print(f"{astro['name']} on the {astro['craft']}")
